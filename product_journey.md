...
tanu ai became a practical exercise in taking a product from an idea to a deployed full-stack application.

the main learning areas were:

* translating a real problem into product requirements.

* thinking through a product beyond its ai component.

* structuring a react and typescript frontend.

* designing and connecting a fastify backend.

* working with third-party apis.

* integrating ai into a product workflow where it provides a practical function rather than existing only as a chatbot.

* handling environment variables and api credentials.

* connecting separate frontend and backend deployments.

* debugging production-specific issues instead of only local development issues.
...
the current version represents the completed scope of the project. future improvements are listed separately and are not presented as existing features.
